...
const ThemeSwitcher = () => {
  ...
  return (
    <Switch
      ...
      className={`${!enabled ? 'bg-gray-50' : 'bg-zinc-700'}
    ...
    >
      ...
      <span
        ...
        className={`${enabled ? 'translate-x-4' : 'translate-x-0'}
            pointer-events-none inline-block h-[34px] w-[34px] rounded-full bg-gray-100 shadow-lg transform ring-0 transition ease-in-out duration-200`}
      />
